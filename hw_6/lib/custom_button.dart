...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    required this.text, required  this.controlleremail, required  this.controllername,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        ...
        ContactInfoGetStorge().addContactInfoToList(name: controllername!.text.toString(), email: controlleremail!.text.toString());
        RefreshCallback;
